    ...
    cron({
      ...
      run: async () => {
        ...
        try {
          ...
          console.error('[CRON:PROFILES] Error details:', error instanceof Error ? error.message : String(error))
    ...
    cron({
      ...
      run: async () => {
        ...
        try {
          ...
          console.error('[CRON:APPS] Error details:', error instanceof Error ? error.message : String(error))
          if (error instanceof Error && error.stack) {
    ...
    cron({
      ...
      run: async () => {
        ...
        try {
          ...
          console.error('[CRON:TASKS] Error details:', error instanceof Error ? error.message : String(error))
          if (error instanceof Error && error.stack) {
