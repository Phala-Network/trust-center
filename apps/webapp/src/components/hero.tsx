          ...
          <div className="relative w-full max-w-md">
            ...
            <div className="absolute inset-0 overflow-hidden rounded-xl">
              ...
              >
                ...
                <g filter="url(#blur1)">
                  <rect width="400" height="700" fill="hsl(var(--muted))" fillOpacity="0.3" />
                  <circle cx="100" cy="550" fill="hsl(var(--primary))" fillOpacity="0.15" r="150" />
                  <circle cx="320" cy="400" fill="hsl(var(--primary))" fillOpacity="0.1" r="120" />
                </g>
            ...
            <div className="relative border border-border/40 bg-background/20 backdrop-blur-sm rounded-xl p-4 h-[700px] overflow-hidden">
