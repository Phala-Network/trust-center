        ...
        <div className="flex-1 flex overflow-hidden">
          ...
          <div className="flex-1 p-4 space-y-4 overflow-y-auto bg-gradient-to-b from-background to-muted/20">
            ...
            <div className="flex justify-start gap-2">
              ...
              <div className="max-w-[80%] bg-card border rounded-2xl rounded-tl-sm px-4 py-3 shadow-sm">
                ...
                <p className="text-sm text-muted-foreground">
                  It's a pleasant day with some clouds. Perfect for outdoor
                  activities!
                </p>
              </div>
            </div>
            ...
            <div className="flex justify-start gap-2">
              ...
              <div className="max-w-[80%] bg-card border rounded-2xl rounded-tl-sm px-4 py-3 shadow-sm">
                <p className="text-sm text-foreground mb-3">
                  Of course! I'd be happy to help you write a professional
                  email. To create the best email for your needs, could you
                  provide me with:
                </p>
                ...
                <p className="text-sm text-muted-foreground">
                  Once you share these details, I'll draft a polished email for
                  you!
                </p>
              </div>
            </div>
            ...
            <div className="flex justify-start gap-2">
              ...
              <div className="max-w-[80%] bg-card border rounded-2xl rounded-tl-sm px-4 py-3 shadow-sm">
                <p className="text-sm text-foreground mb-2">
                  I run inside a Trusted Execution Environment (TEE), which
                  provides hardware-level security:
                </p>
                <ul className="text-sm text-foreground space-y-1.5 mb-3">
                  <li>
                    🔒 <strong>Isolated Processing</strong>: Your data is
                    processed in a secure enclave
                  </li>
                  <li>
                    ✅ <strong>Verified Code</strong>: My source code is
                    cryptographically verified
                  </li>
                  <li>
                    🛡️ <strong>End-to-End Encryption</strong>: All communications
                    are encrypted
                  </li>
                  <li>
                    📜 <strong>Attestation Reports</strong>: You can verify my
                    security claims
                  </li>
                </ul>
                <p className="text-sm text-muted-foreground">
                  Check the Trust Certificate in the sidebar to see the full
