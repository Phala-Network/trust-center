...
async function getOpenGraphStats() {
  try {
...
export default async function Image() {
  const {totalApps, totalProjects} = await getOpenGraphStats()
      ...
      >
        ...
        <div style={{display: 'flex', alignItems: 'flex-start', gap: 24}}>
          ...
          >
            <svg width="60" height="60" viewBox="0 0 48 48" fill="none">
              <path d="M11.2 29.33H16.53V37.33H11.2V29.33Z" fill="#1E2119" />
        ...
        >
          ...
          <div style={{display: 'flex', flexDirection: 'column', gap: 4}}>
            ...
            <span style={{fontSize: 20, color: TEXT_SECONDARY}}>Projects</span>
          </div>
        </div>
